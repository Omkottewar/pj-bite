    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-black text-brand-text font-serif tracking-tight">Write Blog Post</h1>
            <p className="text-sm font-medium text-brand-text-muted">Create a new SEO-optimized article.</p>
          </div>
        </div>
        <button 
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-[#E8E6E1] shadow-sm space-y-5">
            ...
            <div>
              ...
              />
              <p className="text-xs text-brand-text-muted mt-1.5 font-medium">Keep it under 150 characters for best SEO results.</p>
            </div>
          </div>
        </div>
